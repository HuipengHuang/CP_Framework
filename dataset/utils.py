    ...
    if args.imbalance == "True":
        if dataset_name == "cifar10":
            ...
            if args.train_imb == "True":
                ...
                train_dataset = CIFAR10(root='./data/dataset', train=True, transform=train_transform, download=True)
        ...
        train_dataset = CIFAR100(root="~/datasets", download=True, train=True, transform=train_transform)
        cal_test_dataset = CIFAR100(root='~/datasets', download=True, train=False,
